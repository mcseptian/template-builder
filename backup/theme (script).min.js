window.Modernizr = function(e, t, n) {
    ...
    function c(e, t, n) {
      ...
      return i(t, "string") || i(t, "undefined") ? a(o, t) : (o = (e + " " + y.join(r + " ") + r).split(" "), s(o, t, n))
    }
    var l, u, f = {},
      d = t.documentElement,
      ...
      h = "Webkit Moz O ms",
      v = h.split(" "),
      y = h.toLowerCase().split(" "),
      g = {},
      E = [],
      b = E.slice,
      N = {}.hasOwnProperty;
    u = i(N, "undefined") || i(N.call, "undefined") ? function(e, t) {
    ...
    for (var C in g) u(g, C) && (l = C.toLowerCase(), f[l] = g[C](), E.push((f[l] ? "" : "no-") + l));
    return f.addTest = function(e, t) {
      ...
      function(e, t) {
        ...
        function a(e, n) {
          ...
          n = n || i(e);
          for (var o = n.frag.cloneNode(), a = 0, s = r(), c = s.length; a < c; a++) o.createElement(s[a]);
          return o
        }
        ...
        function c(e) {
          e || (e = t);
          var r = i(e);
          return y.shivCSS && !l && !r.hasCSS && (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), u || s(e, r), e
        }
        var l, u, f = e.html5 || {},
        ...
        e.html5 = y, c(t)
      }(this, t), f._version = "2.7.1", f._domPrefixes = y, f._cssomPrefixes = v, f.testProp = function(e) {
        return a([e])
      }, f.testAllProps = c, f.prefixed = function(e, t, n) {
        return t ? c(e, t, n) : c(e, "pfx")
      }, d.className = d.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + " js " + E.join(" "), f
  }(0, this.document),
  function(e, t, n) {
    function r(e) {
    ...
    function c(e, n, r, i, o, c, l) {
      function u(t) {
        if (!p && a(f.readyState) && (E.r = p = 1, !g && s(), f.onload = f.onreadystatechange = null, t)) {
          "img" != e && m(function() {
            N.removeChild(f)
          }, 50);
          for (var r in x[n]) x[n].hasOwnProperty(r) && x[n][r].onload()
        }
      }
      ...
      1 === x[n] && (v = 1, x[n] = []), "object" == e ? f.data = n : (f.src = n, f.type = e), f.width = f.height = "0", f.onerror = f.onload = f.onreadystatechange = function() {
        u.call(this, v)
      }, y.splice(i, 0, E), "img" != e && (v || 2 === x[n] ? (N.insertBefore(f, b ? null : h), m(u, l)) : x[n].push(f))
    }

    function l(e, t, n, r, o) {
      return g = 0, t = t || "j", i(e) ? c("c" == t ? S : C, e, t, this.i++, n, r, o) : (y.splice(this.i++, 0, e), 1 == y.length && s()), this
    }
    ...
    d = function(e) {
      function t(e) {
        ...
        for (n = 0; n < a; n++) r = e[n].split("="), (t = T[r.shift()]) && (o = t(o, r));
      ...
      function a(e, i, o, a, s) {
        var c = t(e),
          l = c.autoCallback;
        c.url.split(".").pop().split("?").shift(), c.bypass || (i && (i = r(i) ? i : i[e] || i[a] || i[e.split("/").pop().split("?")[0]]), c.instead ? c.instead(e, i, o, a, s) : (x[c.url] ? c.noexec = !0 : x[c.url] = 1, o.load(c.url, c.forceCSS || !c.forceJS && "css" == c.url.split(".").pop().split("?").shift() ? "c" : n, c.noexec, c.attrs, c.timeout), (r(i) || r(l)) && o.load(function() {
          u(), i && i(c.origUrl, s, a), l && l(c.origUrl, s, a), x[c.url] = 2
        })))
      }
      ...
      if (i(e)) a(e, 0, f, 0);
        ...
        for (c = 0; c < e.length; c++) l = e[c], i(l) ? a(l, 0, f, 0) : j(l) ? d(l) : Object(l) === l && s(l, f);
  ...
  function() {
    ...
    var t = document.getElementById("trigger-overlay"),
      n = document.querySelector("div.overlay"),
      r = n.querySelector("div.overlay-close");
    transEndEventNames = {
    ...
    }, t.addEventListener("click", e), r.addEventListener("click", e)
  }(),
  function(e) {
    "use strict";
